...
!function(c) {
  ...
  var e = function(h, g) {
    ...
    this.component =
      this.element.is(".date") ? this.element.find(".add-on .fa-calendar, .add-on .fa-time, .add-on .fa-calendar").parent() : false;
  ...
  var b = {modes: [
    ...
    return g
  }, headTemplate: '<thead><tr><th class="prev"><i class="fa fa-arrow-left"/></th><th colspan="5" class="switch"></th><th class="next"><i class="fa fa-arrow-right"/></th></tr></thead>', contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>', footTemplate: '<tfoot><tr><th colspan="7" class="today"></th></tr></tfoot>'};
